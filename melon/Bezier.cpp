...
Bezier::Bezier(bool exist, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) :Shape("Bezier"), is_exist(exist)
{
...
bool Bezier::is_selected(float x, float y)
{
	bool res = false;
...
void Bezier::rotate(POINT old_point, POINT mouse)
{
...
void Bezier::zoom(double factor)
{
